...
public class ConcatDict extends ConcatenatedStringDict
{
    ...
    public byte[] read(int i)
    {
        ...
        int current_ptr = tools.index_tools. byte_to_int(ptr_dict, i * tools.index_tools.INT_SIZE);
    ...
    public void save_to_disk()
    {
        ...
        // save metadata
        try {
            tools.index_tools.int_to_byte(current_int, num_rows);
    ...
    public void load_from_disk()
    {
        ...
        num_rows = tools.index_tools.byte_to_int(num_rows_temp);
        // the last int is ptr to the end of the last word
        ptr_dict = new byte[(num_rows + 1) * tools.index_tools.INT_SIZE];
        // read the dictionary
        try {
